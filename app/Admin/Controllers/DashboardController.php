...
class DashboardController extends AdminController
{
    ...
    public function surveyDataByOffice(Request $request)
    {
        ...
        return response()->json([
            ...
            'overall_satisfaction' => $overallSatisfaction ? $overallSatisfaction . '%' : '0 %',
            'client_type_data' => $clientTypeData,
            'male_count' => $maleCount,
            'female_count' => $femaleCount,
            'age_distribution' => $ageDistribution,
            'rating_counts' => $ratingCounts,
            'cc_satisfaction_percentage' => $ccSatisfactionPercentage ? $ccSatisfactionPercentage . '%' : '0 %',
            'service_satisfaction_percentage' => $serviceSatisfactionPercentage ? $serviceSatisfactionPercentage . '%' : '0 %',
